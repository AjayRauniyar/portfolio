...
const Contact =() => {
 ...
 const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_vrjolnb', 'template_if953jv', formRef.current, {
        publicKey: '60tu8NuWDx6ZS8C5o',
      })
      .then(
        () => {
          console.log('SUCCESS!');
    ...
    return (
       ...
       <motion.div className="item"variants={variants}>
        <h2>Gmail</h2>
        <span>ajayrauniyarsince2005@gmail.com</span>
       </motion.div>
       <motion.div className="item" variants={variants}>
        <h2>Address</h2>
        <span>Avahallali,Bangalore</span>
       </motion.div>
       <motion.div className="item" variants={variants}>
        <h2>Phone</h2>
        <span>+91 8603744042</span>
       </motion.div>
        </motion.div>
        ...
        <motion.form ref={formRef} onSubmit={sendEmail} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay: 3,duration: 1}}>
            ...
            <input type="eami" required placeholder="Email" name="email"/>
